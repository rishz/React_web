...
1 verbose cli [ '/usr/local/bin/node', '/usr/local/bin/npm', 'run', 'webpack' ]
...
5 verbose cwd /Users/rishabhshukla/WebstormProjects/React_web/node_modules/webpack
6 error Darwin 16.0.0
7 error argv "/usr/local/bin/node" "/usr/local/bin/npm" "run" "webpack"
8 error node v6.9.1
9 error npm  v3.10.8
